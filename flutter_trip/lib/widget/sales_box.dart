...
class SalesBox extends StatelessWidget {
  ...
  const SalesBox({@required this.salesBox}) : super();
    ...
    return Column(
      children: <Widget>[
        Container(
          ...
          decoration: BoxDecoration(
            border: Border(
              bottom: BorderSide(width: 1, color: Color(0xfff2f2))
            )
          ),
          child: Row(
    ...
    return GestureDetector(
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) => WebView(
                    url: model.url,
                    stateBarColor: model.statusBarColor,
      ...
      child: Container(
        ...
        child: Image.network(
          model.icon,
          fit: BoxFit.fill,
          width: MediaQuery.of(context).size.width / 2 - 10, // 屏幕宽度的一半-5
          height: big ? 129: 80,
        ),
      )
    );
